...
const genAI = new GoogleGenerativeAI("AIzaSyCrzZ9OPFAuypAYAL5gzhOXlvkxT0wgamg");
const models = genAI.getGenerativeModel({ model: "gemini-1.5-flash" });
app.use(express.json());
app.use(cors());
mongoose.connect('mongodb+srv://habeebsalehalhussain:windows11@cluster7.lhizk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster9', {
